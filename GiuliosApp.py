...
class MovingAverages():
    def __init__(self, symbol: str = '', reqId: float = 0, ma50: float = 0, ma200: float = 0):
        self.symbol = symbol
        self.reqId = reqId
        self.firstma50 = ma50
        self.firstma200 = ma200
    ...
    def setMa50(self, ma50):
        self.ma50 = ma50

    def setMa200(self, ma200):
        self.ma200 = ma200
...
class Window(qt.QWidget):
    ...
    def error_cb(self, error, reqId, errorCode, errorString):
        logging.error("error: " + str(error) + " , " + str(reqId) + " , " + str(errorCode) + " , " + str(errorString))
        if(errorCode == 1300):
    ...
    def exec_details_cb(self, trade, fill):
        logging.info("exec details for orderid " + str(fill.execution.orderId))
        logging.info(fill.execution)
    ...
    def add_historical(self, text=''):
        ...
        if text:
            ...
            ma = MovingAverages(symbol, bars.reqId, round(ma50.tail(1).item(), 6), round(ma200.tail(1).item(), 6))
